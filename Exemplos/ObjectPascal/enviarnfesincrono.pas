...
begin
  ...
  try
    ...
    statusRetorno := Trim(IntToStr(oAutorizacao.Result.CStat)) + ' ' + VarToStr(oAutorizacao.Result.XMotivo + ' - Aplicação que está respondendo: ' + oAutorizacao.Result.VerAplic);
